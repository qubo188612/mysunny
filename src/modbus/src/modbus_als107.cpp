...
int Modbus::als107_task_parameter(int ddr,u_int16_t num)
{
    switch(ddr)
    {
        ...
        case ALS107_PINGJUN_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_pingjun_min&&(int)num<=(int)e2proomdata.als107_pingjun_max)
            {
        ...
        case ALS107_B_YANMOFUZHU_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_b_yanmofuzhu_min&&(int)num<=(int)e2proomdata.als107_b_yanmofuzhu_max)
            {
        ...
        case ALS107_B_GUDINGQUYU_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_b_gudingquyu_min&&(int)num<=(int)e2proomdata.als107_b_gudingquyu_max)
            {
        ...
        case ALS107_WIDTHLIANTONGDIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_widthliantongdis_min&&(int)num<=(int)e2proomdata.als107_widthliantongdis_max)
            {
        ...
        case ALS107_HIGHLIANTONGDIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_highliantongdis_min&&(int)num<=(int)e2proomdata.als107_highliantongdis_max)
            {
        ...
        case ALS107_GUJIAERZHI_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_gujiaerzhi_min&&(int)num<=(int)e2proomdata.als107_gujiaerzhi_max)
            {
        ...
        case ALS107_JIGUANGHIGHT_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_jiguanghight_min&&(int)num<=(int)e2proomdata.als107_jiguanghight_max)
            {
        ...
        case ALS107_JIGUANGLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_jiguanglong_min&&(int)num<=(int)e2proomdata.als107_jiguanglong_max)
            {
        ...
        case ALS107_JIGUANGKUANDU_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_jiguangkuandu_min&&(int)num<=(int)e2proomdata.als107_jiguangkuandu_max)
            {
        ...
        case ALS107_UPDIF_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Updif_min&&(int)num<=(int)e2proomdata.als107_Updif_max)
            {
        ...
        case ALS107_UPDIFMIN_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Updifmin_min&&(int)num<=(int)e2proomdata.als107_Updifmin_max)
            {
        ...
        case ALS107_UPLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Uplong_min&&(int)num<=(int)e2proomdata.als107_Uplong_max)
            {
        ...
        case ALS107_DOWNDIF_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Downdif_min&&(int)num<=(int)e2proomdata.als107_Downdif_max)
            {
        ...
        case ALS107_DOWNDIFMIN_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Downdifmin_min&&(int)num<=(int)e2proomdata.als107_Downdifmin_max)
            {
        ...
        case ALS107_DOWNDLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Downdlong_min&&(int)num<=(int)e2proomdata.als107_Downdlong_max)
            {
        ...
        case ALS107_ST_DOWN_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_St_Down_min&&(int)num<=(int)e2proomdata.als107_St_Down_max)
            {
        ...
        case ALS107_ED_DOWN_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Ed_Down_min&&(int)num<=(int)e2proomdata.als107_Ed_Down_max)
            {
        ...
        case ALS107_ST_UP_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_St_Up_min&&(int)num<=(int)e2proomdata.als107_St_Up_max)
            {
        ...
        case ALS107_ED_UP_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_Ed_Up_min&&(int)num<=(int)e2proomdata.als107_Ed_Up_max)
            {
        ...
        case ALS107_DIS_CENTER_ST_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_dis_center_st_min&&(int)num<=(int)e2proomdata.als107_dis_center_st_max)
            {
        ...
        case ALS107_DIS_CENTER_ST2_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_dis_center_st2_min&&(int)num<=(int)e2proomdata.als107_dis_center_st2_max)
            {
        ...
        case ALS107_DIS_CENTER_ED2_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_dis_center_ed2_min&&(int)num<=(int)e2proomdata.als107_dis_center_ed2_max)
            {
        ...
        case ALS107_B_KALMANFILTER_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_b_KalmanFilter_min&&(int)num<=(int)e2proomdata.als107_b_KalmanFilter_max)
            {
        ...
        case ALS107_KALMANQF_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_KalmanQF_min&&(int)num<=(int)e2proomdata.als107_KalmanQF_max)
            {
        ...
        case ALS107_KALMANRF_REG_ADD:
            if((int)num>=(int)e2proomdata.als107_KalmanRF_min&&(int)num<=(int)e2proomdata.als107_KalmanRF_max)
            {

...
void E2proomData::als101_read_para()
{
    Uint8 *buff=NULL;
    CFileOut fo;
    ...
    if(buff==NULL)
        return;
    if(0 > fo.ReadFile(E2POOM_ALG101_LASERIMAGEPOS_SYSPATH_MOTO,buff,E2POOM_ALG101_LASERIMAGEPOS_SAVEBUFF))
    {
        init_als101_para();
        if(buff!=NULL)
        {
...
void E2proomData::write_als101_para()
{
    Uint8 *buff=NULL;
    CFileOut fo;
    ...
    *i16_p=als101_dis_center_ed;
    ...
    fo.WriteFile(E2POOM_ALG101_LASERIMAGEPOS_SYSPATH_MOTO,buff,E2POOM_ALG101_LASERIMAGEPOS_SAVEBUFF);

...
int Modbus::als106_task_parameter(int ddr,u_int16_t num)
{
    switch(ddr)
    {
        ...
        case ALG106_UPBACK_ED_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_DOWNBACK_ST_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_DOWNBACK_ED_REG_ADD:
        ...
        case ALG106_DOWNDLONG_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_DISCENTER_ED_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_DUANDIANJULI_REG_ADD:
        ...
        case ALG106_POKOUUPDIF_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUUPDIFMIN_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUUPBACK_ST_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUUPBACK_ED_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDOWNDIF_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDOWNDIFMIN_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDOWNBACK_ST_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDOWNBACK_ED_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUUPLONG_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDOWNLONG_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_B_POKOUYAOBIAN_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUYAOBIANHSIZE_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUDUANXIANERZHI_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUSEARCHDECTANCEMAX_REG_ADD:
            ...
            return 1;
        break;
        case ALG106_POKOUSEARCHDECTANCEMIN_REG_ADD:
...
void Modbus::init_als106_parameter()
{
    ...
    parameterport_mapping->tab_registers[ALG106_DIFMIN_REG_ADD]=e2proomdata.als106_difmin;
    parameterport_mapping->tab_registers[ALG106_SIDELONG_REG_ADD]=e2proomdata.als106_Sidelong;
    parameterport_mapping->tab_registers[ALG106_UPBACK_ST_REG_ADD]=e2proomdata.als106_Upback_st;
    parameterport_mapping->tab_registers[ALG106_UPBACK_ED_REG_ADD]=e2proomdata.als106_Upback_ed;
    parameterport_mapping->tab_registers[ALG106_DOWNBACK_ST_REG_ADD]=e2proomdata.als106_Downback_st;
    parameterport_mapping->tab_registers[ALG106_DOWNBACK_ED_REG_ADD]=e2proomdata.als106_Downback_ed;
    parameterport_mapping->tab_registers[ALG106_UPMINDIS_REG_ADD]=e2proomdata.als106_Upmindis;
    parameterport_mapping->tab_registers[ALG106_DOWNMINDIS_REG_ADD]=e2proomdata.als106_Downmindis;
    parameterport_mapping->tab_registers[ALG106_UPLONG_REG_ADD]=e2proomdata.als106_Uplong;
    parameterport_mapping->tab_registers[ALG106_DOWNDLONG_REG_ADD]=e2proomdata.als106_Downdlong;
    parameterport_mapping->tab_registers[ALG106_DISCENTER_ED_REG_ADD]=e2proomdata.als106_dis_center_ed;
    parameterport_mapping->tab_registers[ALG106_DUANDIANJULI_REG_ADD]=e2proomdata.als106_duandianjuli;
    parameterport_mapping->tab_registers[ALG106_POKOUMOD_REG_ADD]=e2proomdata.als106_pokoumod;
    parameterport_mapping->tab_registers[ALG106_POKOUUPDIF_REG_ADD]=e2proomdata.als106_pokouUpdif;
    parameterport_mapping->tab_registers[ALG106_POKOUUPDIFMIN_REG_ADD]=e2proomdata.als106_pokouUpdifmin;
    parameterport_mapping->tab_registers[ALG106_POKOUUPBACK_ST_REG_ADD]=e2proomdata.als106_pokouUpback_st;
    parameterport_mapping->tab_registers[ALG106_POKOUUPBACK_ED_REG_ADD]=e2proomdata.als106_pokouUpback_ed;
    parameterport_mapping->tab_registers[ALG106_POKOUDOWNDIF_REG_ADD]=e2proomdata.als106_pokouDowndif;
    parameterport_mapping->tab_registers[ALG106_POKOUDOWNDIFMIN_REG_ADD]=e2proomdata.als106_pokouDowndifmin;
    parameterport_mapping->tab_registers[ALG106_POKOUDOWNBACK_ST_REG_ADD]=e2proomdata.als106_pokouDownback_st;
    parameterport_mapping->tab_registers[ALG106_POKOUDOWNBACK_ED_REG_ADD]=e2proomdata.als106_pokouDownback_ed;
    parameterport_mapping->tab_registers[ALG106_POKOUUPLONG_REG_ADD]=e2proomdata.als106_pokouUplong;
    parameterport_mapping->tab_registers[ALG106_POKOUDOWNLONG_REG_ADD]=e2proomdata.als106_pokouDownlong;
    parameterport_mapping->tab_registers[ALG106_B_POKOUYAOBIAN_REG_ADD]=e2proomdata.als106_b_pokouyaobian;
    parameterport_mapping->tab_registers[ALG106_POKOUYAOBIANHSIZE_REG_ADD]=e2proomdata.als106_pokouyaobianHsize;
    parameterport_mapping->tab_registers[ALG106_POKOUDUANXIANERZHI_REG_ADD]=e2proomdata.als106_pokouduanxianerzhi;
    parameterport_mapping->tab_registers[ALG106_POKOUSEARCHDECTANCEMAX_REG_ADD]=e2proomdata.als106_pokousearchdectancemax;
    parameterport_mapping->tab_registers[ALG106_POKOUSEARCHDECTANCEMIN_REG_ADD]=e2proomdata.als106_pokousearchdectancemin;
}

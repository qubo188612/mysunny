...
int Modbus::als102_task_parameter(int ddr,u_int16_t num)
{
    switch(ddr)
    {
        ...
        case ALS102_PINGJUN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_pingjun_min&&(int)num<=(int)e2proomdata.als102_pingjun_max)
            {
        ...
        case ALS102_B_YANMOFUZHU_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_yanmofuzhu_min&&(int)num<=(int)e2proomdata.als102_b_yanmofuzhu_max)
            {
        ...
        case ALS102_B_GUDINGQUYU_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_gudingquyu_min&&(int)num<=(int)e2proomdata.als102_b_gudingquyu_max)
            {
        ...
        case ALS102_WIDTHLIANTONGDIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_widthliantongdis_min&&(int)num<=(int)e2proomdata.als102_widthliantongdis_max)
            {
        ...
        case ALS102_HIGHLIANTONGDIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_highliantongdis_min&&(int)num<=(int)e2proomdata.als102_highliantongdis_max)
            {
        ...
        case ALS102_GUJIAERZHI_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_gujiaerzhi_min&&(int)num<=(int)e2proomdata.als102_gujiaerzhi_max)
            {
        ...
        case ALS102_JIGUANGHIGHT_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_jiguanghight_min&&(int)num<=(int)e2proomdata.als102_jiguanghight_max)
            {
        ...
        case ALS102_JIGUANGLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_jiguanglong_min&&(int)num<=(int)e2proomdata.als102_jiguanglong_max)
            {
        ...
        case ALS102_JIGUANGKUANDU_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_jiguangkuandu_min&&(int)num<=(int)e2proomdata.als102_jiguangkuandu_max)
            {
        ...
        case ALS102_UPDIF_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Updif_min&&(int)num<=(int)e2proomdata.als102_Updif_max)
            {
        ...
        case ALS102_UPDIFMIN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Updifmin_min&&(int)num<=(int)e2proomdata.als102_Updifmin_max)
            {
        ...
        case ALS102_UPLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Uplong_min&&(int)num<=(int)e2proomdata.als102_Uplong_max)
            {
        ...
        case ALS102_DOWNDIF_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Downdif_min&&(int)num<=(int)e2proomdata.als102_Downdif_max)
            {
        ...
        case ALS102_DOWNDIFMIN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Downdifmin_min&&(int)num<=(int)e2proomdata.als102_Downdifmin_max)
            {
        ...
        case ALS102_DOWNDLONG_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Downdlong_min&&(int)num<=(int)e2proomdata.als102_Downdlong_max)
            {
        ...
        case ALS102_ST_DOWN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_St_Down_min&&(int)num<=(int)e2proomdata.als102_St_Down_max)
            {
        ...
        case ALS102_ED_DOWN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Ed_Down_min&&(int)num<=(int)e2proomdata.als102_Ed_Down_max)
            {
        ...
        case ALS102_ST_UP_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_St_Up_min&&(int)num<=(int)e2proomdata.als102_St_Up_max)
            {
        ...
        case ALS102_ED_UP_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Ed_Up_min&&(int)num<=(int)e2proomdata.als102_Ed_Up_max)
            {
        ...
        case ALS102_UPDIF2_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Updif2_min&&(int)num<=(int)e2proomdata.als102_Updif2_max)
            {
        ...
        case ALS102_UPDIFMIN2_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Updifmin2_min&&(int)num<=(int)e2proomdata.als102_Updifmin2_max)
            {
        ...
        case ALS102_DIS_CENTER_ST_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_st_min&&(int)num<=(int)e2proomdata.als102_dis_center_st_max)
            {
        ...
        case ALS102_DIS_CENTER_ED_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_ed_min&&(int)num<=(int)e2proomdata.als102_dis_center_ed_max)
            {
        ...
        case ALS102_B_OPENGUDINGDIMIAN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_opengudingdimian_min&&(int)num<=(int)e2proomdata.als102_b_opengudingdimian_max)
            {
        ...
        case ALS102_DIMIANPANGDINGJULI_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dimianpangdingjuli_min&&(int)num<=(int)e2proomdata.als102_dimianpangdingjuli_max)
            {
        ...
        case ALS102_DIMIANPINGJUNSHUNUM_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dimianpingjunshunum_min&&(int)num<=(int)e2proomdata.als102_dimianpingjunshunum_max)
            {
        ...
        case ALS102_DIS_CENTER_ST2_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_st2_min&&(int)num<=(int)e2proomdata.als102_dis_center_st2_max)
            {
        ...
        case ALS102_DIS_CENTER_ED2_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_ed2_min&&(int)num<=(int)e2proomdata.als102_dis_center_ed2_max)
            {
        ...
        case ALS102_DIS_CENTER_ST3_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_st3_min&&(int)num<=(int)e2proomdata.als102_dis_center_st3_max)
            {
        ...
        case ALS102_DIS_CENTER_ED3_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_dis_center_ed3_min&&(int)num<=(int)e2proomdata.als102_dis_center_ed3_max)
            {
        ...
        case ALS102_XUEXIJULI_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_xuexijuli_min&&(int)num<=(int)e2proomdata.als102_xuexijuli_max)
            {
        ...
        case ALS102_B_PINGPOWENGDING_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_pingpowending_min&&(int)num<=(int)e2proomdata.als102_b_pingpowending_max)
            {
        ...
        case ALS102_PINGPOWENGDING_DIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_pingpowending_dis_min&&(int)num<=(int)e2proomdata.als102_pingpowending_dis_max)
            {
        ...
        case ALS102_B_XIELVOPEN_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_xielvopen_min&&(int)num<=(int)e2proomdata.als102_b_xielvopen_max)
            {
        ...
        case ALS102_XIELVFANWEI_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_xielvfanwei_min&&(int)num<=(int)e2proomdata.als102_xielvfanwei_max)
            {
        ...
        case ALS102_UPLONG2_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_Uplong2_min&&(int)num<=(int)e2proomdata.als102_Uplong2_max)
            {
        ...
        case ALS102_CEBANKONGDONGDIS_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_cebankongdongdis_min&&(int)num<=(int)e2proomdata.als102_cebankongdongdis_max)
            {
        ...
        case ALS102_QIATOUQUWEI_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_qiatouquweijuli_min&&(int)num<=(int)e2proomdata.als102_qiatouquweijuli_max)
            {
        ...
        case ALS102_ANSWERPOINT_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_answerpoint_min&&(int)num<=(int)e2proomdata.als102_answerpoint_max)
            {
        ...
        case ALS102_B_KALMANFILTER_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_b_KalmanFilter_min&&(int)num<=(int)e2proomdata.als102_b_KalmanFilter_max)
            {
        ...
        case ALS102_KALMANQF_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_KalmanQF_min&&(int)num<=(int)e2proomdata.als102_KalmanQF_max)
            {
        ...
        case ALS102_KALMANRF_REG_ADD:
            if((int)num>=(int)e2proomdata.als102_KalmanRF_min&&(int)num<=(int)e2proomdata.als102_KalmanRF_max)
            {

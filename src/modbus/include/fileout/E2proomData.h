...
#define E2POOM_ALG100_LASERIMAGEPOS_EXPOSURE_TIME_USE				150        //曝光默认值   
...
#define E2POOM_ALG101_LASERIMAGEPOS_EXPOSURE_TIME_USE				150        //曝光默认值   
...
/****************************/
    ...
    void write_als101_para();				//保存任务100参数
    void init_als101_para();				//初始化任务100参数
    //默认参数

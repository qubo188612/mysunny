...
def generate_launch_description():
    ...
    remappings=[('~/input_robpos','/modbus_node/input_robpos')],
    ...
    my_pclout  = Node(                                 
         ...
         remappings=[('~/pcllineresult', '/pcl_cloud_node/lineresult'),('~/cloudresult','/line_center_reconstruction_node/cloud_task100_199')])

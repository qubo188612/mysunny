...
bool tutorial_interfaces__msg__if_algorhmittargetrobpoint3f__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._if_algorhmittargetrobpoint3f.IfAlgorhmittargetrobpoint3f", full_classname_dest, 81) == 0);
  }
  tutorial_interfaces__msg__IfAlgorhmittargetrobpoint3f * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of IfAlgorhmittargetrobpoint3f */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._if_algorhmittargetrobpoint3f");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IfAlgorhmittargetrobpoint3f");

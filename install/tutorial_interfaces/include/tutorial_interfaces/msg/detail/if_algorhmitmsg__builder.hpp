...
class Init_IfAlgorhmitmsg_robpos
{
public:
  explicit Init_IfAlgorhmitmsg_robpos(::tutorial_interfaces::msg::IfAlgorhmitmsg & msg)
  : msg_(msg)
  {}
  Init_IfAlgorhmitmsg_solderjoints robpos(::tutorial_interfaces::msg::IfAlgorhmitmsg::_robpos_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_IfAlgorhmitmsg_robpos lasertrackout(::tutorial_interfaces::msg::IfAlgorhmitmsg::_lasertrackout_type arg)
  {
    msg_.lasertrackout = std::move(arg);
    return Init_IfAlgorhmitmsg_robpos(msg_);
  }

...
static rosidl_typesupport_introspection_c__MessageMember IfAlgorhmitmsg__rosidl_typesupport_introspection_c__IfAlgorhmitmsg_message_member_array[6] = {
  {
    "result",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__msg__IfAlgorhmitmsg, robpos),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, msg, IfAlgorhmitmsg)() {
  ...
  IfAlgorhmitmsg__rosidl_typesupport_introspection_c__IfAlgorhmitmsg_message_member_array[4].members_ =

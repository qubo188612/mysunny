...
#define NODE_MAIN_LOGGER_NAME "cloud_result_tcpip_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcloud_result_tcpip.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<cloud_result_tcpip::Cloud_Result_Tcpip>";

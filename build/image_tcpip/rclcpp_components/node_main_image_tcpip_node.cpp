...
#define NODE_MAIN_LOGGER_NAME "image_tcpip_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_tcpip.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_tcpip::Image_Tcpip>";

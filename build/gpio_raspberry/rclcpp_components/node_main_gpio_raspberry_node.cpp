...
#define NODE_MAIN_LOGGER_NAME "gpio_raspberry_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgpio_raspberry.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<gpio_raspberry::GpioRaspberry>";

...
#define NODE_MAIN_LOGGER_NAME "rotate_image_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librotate_image.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rotate_image::RotateImage>";

...
#define NODE_MAIN_LOGGER_NAME "line_center_reconstruction_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libline_center_reconstruction.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<line_center_reconstruction::LineCenterReconstruction>";

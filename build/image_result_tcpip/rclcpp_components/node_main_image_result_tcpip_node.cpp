...
#define NODE_MAIN_LOGGER_NAME "image_result_tcpip_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_result_tcpip.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_result_tcpip::Image_Result_Tcpip>";

...
#define NODE_MAIN_LOGGER_NAME "my_pclout_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmy_pclout.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<my_pclout::My_Pclout>";

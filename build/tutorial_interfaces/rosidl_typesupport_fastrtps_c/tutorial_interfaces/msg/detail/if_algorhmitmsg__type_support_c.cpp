...
#include "tutorial_interfaces/msg/detail/if_algorhmitmsg__rosidl_typesupport_fastrtps_c.h"
...
using _IfAlgorhmitmsg__ros_msg_type = tutorial_interfaces__msg__IfAlgorhmitmsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IfAlgorhmitmsg__ros_msg_type * ros_message = static_cast<const _IfAlgorhmitmsg__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
  ...
  void * untyped_ros_message)
{
  ...
  _IfAlgorhmitmsg__ros_msg_type * ros_message = static_cast<_IfAlgorhmitmsg__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_tutorial_interfaces__msg__IfAlgorhmitmsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IfAlgorhmitmsg__ros_msg_type * ros_message = static_cast<const _IfAlgorhmitmsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IfAlgorhmitmsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__IfAlgorhmitmsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__IfAlgorhmitmsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tutorial_interfaces__msg__IfAlgorhmitmsg(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_IfAlgorhmitmsg = {
...
static rosidl_message_type_support_t _IfAlgorhmitmsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IfAlgorhmitmsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, IfAlgorhmitmsg)() {
  return &_IfAlgorhmitmsg__type_support;
}

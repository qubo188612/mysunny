...
#include "tutorial_interfaces/msg/detail/if_algorhmittargetpoint4f__rosidl_typesupport_fastrtps_c.h"
...
using _IfAlgorhmittargetpoint4f__ros_msg_type = tutorial_interfaces__msg__IfAlgorhmittargetpoint4f;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IfAlgorhmittargetpoint4f__ros_msg_type * ros_message = static_cast<const _IfAlgorhmittargetpoint4f__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _IfAlgorhmittargetpoint4f__ros_msg_type * ros_message = static_cast<_IfAlgorhmittargetpoint4f__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _IfAlgorhmittargetpoint4f__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__IfAlgorhmittargetpoint4f(
...
{
  return max_serialized_size_tutorial_interfaces__msg__IfAlgorhmittargetpoint4f(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_IfAlgorhmittargetpoint4f = {
...
static rosidl_message_type_support_t _IfAlgorhmittargetpoint4f__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IfAlgorhmittargetpoint4f,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, IfAlgorhmittargetpoint4f)() {
  return &_IfAlgorhmittargetpoint4f__type_support;
}

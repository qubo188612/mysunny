...
static const _IfAlgorhmitpoint2f_type_support_symbol_names_t _IfAlgorhmitpoint2f_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, IfAlgorhmitpoint2f)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, msg, IfAlgorhmitpoint2f)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tutorial_interfaces, msg, IfAlgorhmitpoint2f)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_c::IfAlgorhmitpoint2f_message_type_support_handle;
}

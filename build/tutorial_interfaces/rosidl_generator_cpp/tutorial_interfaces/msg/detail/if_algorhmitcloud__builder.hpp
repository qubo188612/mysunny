...
class Init_IfAlgorhmitcloud_robpos
{
public:
  explicit Init_IfAlgorhmitcloud_robpos(::tutorial_interfaces::msg::IfAlgorhmitcloud & msg)
  : msg_(msg)
  {}
  Init_IfAlgorhmitcloud_solderjoints robpos(::tutorial_interfaces::msg::IfAlgorhmitcloud::_robpos_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_IfAlgorhmitcloud_robpos targetpointoutcloud(::tutorial_interfaces::msg::IfAlgorhmitcloud::_targetpointoutcloud_type arg)
  {
    msg_.targetpointoutcloud = std::move(arg);
    return Init_IfAlgorhmitcloud_robpos(msg_);
  }

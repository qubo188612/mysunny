...
static rosidl_typesupport_introspection_c__MessageMember IfAlgorhmitcloud__rosidl_typesupport_introspection_c__IfAlgorhmitcloud_message_member_array[5] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__msg__IfAlgorhmitcloud, robpos),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tutorial_interfaces, msg, IfAlgorhmitcloud)() {
  ...
  IfAlgorhmitcloud__rosidl_typesupport_introspection_c__IfAlgorhmitcloud_message_member_array[3].members_ =

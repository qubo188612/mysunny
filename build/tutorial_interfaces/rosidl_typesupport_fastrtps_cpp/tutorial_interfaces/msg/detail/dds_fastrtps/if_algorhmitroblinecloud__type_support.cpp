...
#include "tutorial_interfaces/msg/detail/if_algorhmitroblinecloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tutorial_interfaces::msg::IfAlgorhmitrobpoint3f &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tutorial_interfaces::msg::IfAlgorhmitrobpoint3f &);
size_t get_serialized_size(
  const tutorial_interfaces::msg::IfAlgorhmitrobpoint3f &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const tutorial_interfaces::msg::IfAlgorhmittargetrobpoint3f &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tutorial_interfaces::msg::IfAlgorhmittargetrobpoint3f &);
size_t get_serialized_size(
  const tutorial_interfaces::msg::IfAlgorhmittargetrobpoint3f &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const tutorial_interfaces::msg::IfAlgorhmitroblinecloud & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::IfAlgorhmitroblinecloud & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: lasertrackoutcloud
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        tutorial_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_IfAlgorhmitrobpoint3f(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: targetpointoutcloud
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        tutorial_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_IfAlgorhmittargetrobpoint3f(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::IfAlgorhmitroblinecloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::IfAlgorhmitroblinecloud *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IfAlgorhmitroblinecloud__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::IfAlgorhmitroblinecloud *>(
...
{
  return max_serialized_size_IfAlgorhmitroblinecloud(full_bounded, 0);
}

static message_type_support_callbacks_t _IfAlgorhmitroblinecloud__callbacks = {
...
static rosidl_message_type_support_t _IfAlgorhmitroblinecloud__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IfAlgorhmitroblinecloud__callbacks,
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_IfAlgorhmitroblinecloud__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, IfAlgorhmitroblinecloud)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_IfAlgorhmitroblinecloud__handle;
}

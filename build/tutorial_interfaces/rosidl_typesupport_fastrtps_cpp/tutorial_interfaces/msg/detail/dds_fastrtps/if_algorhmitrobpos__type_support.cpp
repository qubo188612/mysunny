...
#include "tutorial_interfaces/msg/detail/if_algorhmitrobpos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::IfAlgorhmitrobpos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::IfAlgorhmitrobpos & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::IfAlgorhmitrobpos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::IfAlgorhmitrobpos *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IfAlgorhmitrobpos__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::IfAlgorhmitrobpos *>(
...
{
  return max_serialized_size_IfAlgorhmitrobpos(full_bounded, 0);
}

static message_type_support_callbacks_t _IfAlgorhmitrobpos__callbacks = {
...
static rosidl_message_type_support_t _IfAlgorhmitrobpos__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IfAlgorhmitrobpos__callbacks,
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_IfAlgorhmitrobpos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, IfAlgorhmitrobpos)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_IfAlgorhmitrobpos__handle;
}

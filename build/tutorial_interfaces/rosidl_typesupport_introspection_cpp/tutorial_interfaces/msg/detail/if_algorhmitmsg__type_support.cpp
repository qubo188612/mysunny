...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IfAlgorhmitmsg_message_member_array[6] = {
  {
    "result",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::IfAlgorhmitmsg, robpos),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer

...
#define NODE_MAIN_LOGGER_NAME "laser_imagepos_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblaser_imagepos.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<laser_imagepos::LaserImagePos>";

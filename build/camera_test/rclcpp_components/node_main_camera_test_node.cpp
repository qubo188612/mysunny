...
#define NODE_MAIN_LOGGER_NAME "camera_test_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcamera_test.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<camera_test::CameraTest>";

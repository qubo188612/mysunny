...
#define NODE_MAIN_LOGGER_NAME "laser_line_center_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblaser_line_center.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<laser_line_center::LaserLineCenter>";

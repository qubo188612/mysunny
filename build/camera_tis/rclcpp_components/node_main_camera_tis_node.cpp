...
#define NODE_MAIN_LOGGER_NAME "camera_tis_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcamera_tis.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<camera_tis::CameraTis>";
